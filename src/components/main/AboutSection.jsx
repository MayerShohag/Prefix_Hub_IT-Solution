...
export default function AboutUs() {
     return (
          <section
               className="bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 py-16 px-6 sm:px-12 lg:px-20"
          ...
          >
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                         ...
                         <div className="prose max-w-none dark:prose-invert text-gray-700 dark:text-gray-200">
                              <p>
                         ...
                         <div className="flex flex-wrap gap-3">
                              ...
                              <Link
                                   to="/about"
                                   className="inline-flex items-center gap-2 rounded-lg px-5 py-3 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none"
                              >
                                   Careers
                              </Link>
                         </div>
                    ...
                    <div className="grid gap-6">
                         <div className="rounded-xl p-6 bg-gray-700/20 border border-gray-700 shadow-md">
